...
export default function cdseToGeojson(response,startIndex) {
...
console.log(item)
        try {
            ...
            // for (let i = 0; i < item.properties.links.length; i++) {
            //     if (item.properties.links[i]['@']['title'] === 'Download') downloadurl = item.properties.link[i]['@']['href']
            //     if (item.properties.links[i]['@']['title'] === 'Quicklook') quicklookurl = item.properties.link[i]['@']['href']
            // }
